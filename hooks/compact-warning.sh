...
print(f"[CONTEXT WARNING] Context at ~{est['pct']}% (~{tokens_k}k estimated tokens of 1M). Run /compact now to compress the conversation and free up context.", file=sys.stderr)
sys.exit(2)
PYEOF
